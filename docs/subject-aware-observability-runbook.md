...
- Prometheus, OTLP, OCI Monitoring, StatsD, Datadog, Amazon CloudWatch, Azure
  Monitor, syslog, Splunk HEC, and `nats-sink-metrics` render the same
  prepared low-cardinality rows.
